...
program.version('1.0.0').description('Quip Rest API Command Line').option('-c, --config <path>', "Quip Configuration file. Default to ~/" + CONFIG_DIR + "/" + CONFIG_FILE).option('-t, --accessToken <token>', 'Quip Access Token').option('-d, --debug', 'Enabling Debugging Output').on('--help', function() {
